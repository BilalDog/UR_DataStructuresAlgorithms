# -*- coding: utf-8 -*-
"""Kopie von Willkommen bei Colab

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DfjLyfSfwQFOxJ3dsXuafo8mUL1wjh-a
"""
...
def section_2_strings(attendance_data, buildings, total, average, minimum, maximum):
    print_section_header("STRINGS")

    # report
    report_title = f"Fire drill attendance report - {len(attendance_data)} buildings"
    summary_line = f"Total: {total} participants, average: {average:.1f} per building"
    range_info = f"Attendance range: {minimum} (lowest) to {maximum} (highest)"

    print("General report:")
    print(f"Fire drill attendance report - {len(attendance_data)} buildings")
    print(f"Total: {total} participants, average: {average:.1f} per building")
    print(f"Attendance range: {minimum} (lowest) to {maximum} (highest)")
...
def main():
    attendance_data, buildings, total, average, minimum, maximum = values()
    section_2_strings(attendance_data, buildings, total, average, minimum, maximum)

if __name__ == "__main__":
    main()

def section_3_booleans(average, minimum, attendance_data):
    ...
    print(f"Current values: average = {average:.1f}, minimum = {minimum}")
    ...
    #boolean conditions
    meets_standards = above_avg_threshold and above_min_threshold
    excellent_performance = average > 90 and minimum > 80
    ...
    if excellent_performance:
        print("BONUS: Excellent Performance!")

def main():
    attendance_data, buildings, total, average, minimum, maximum = values()
    section_3_booleans(average, minimum, attendance_data)
